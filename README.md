...
- To install and set up Python and Jupyter notebooks, follow the instructions at [`python_setup.md`](https://blas-ko.github.io/uc3m_networks_workshop_2025/python_setup.md)
