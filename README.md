...
- To install and set up Python and Jupyter notebooks, follow the instructions at [`python_setup.md`](https://github.com/blas-ko/uc3m_networks_workshop_2025/blob/main/python_setup.md)
...
4. **Dynamics on networks** ([slides](https://blas-ko.github.io/uc3m_networks_workshop_2025/session_4/04_dynamics_on_networks_slides.pdf), [tutorial (viewer)](https://blas-ko.github.io/uc3m_networks_workshop_2025/session_4/04_dynamics_on_networks.html), [session folder](https://download-directory.github.io/?url=https://github.com/blas-ko/uc3m_networks_workshop_2025/tree/main/session_4))
